...
<html>
  <head>
    ...
    <script type="text/javascript">
      ...
      function openInfo () {
        if($("#addinformation").css("display") == "none"){
          $("#addinformation").css("display","inline");
        }else{
...
&lt;/ul>
        ...
        <div class="addinformation" id="addinformation">
          hi<br />
          adfawegerg<br />
          rwrherherhe<br />
          rhwerherher
        </div>
        <button class="addpublish" onclick="openInfo()">新增公告+</button>
      </div><!-- /.content-wrapper -->
